    ...
    <script src="<?php echo RAIZ . '/vista/slick/slick.js'; ?>"></script>
    <script src="<?php echo RAIZ . '/vista/js/estilo.js'; ?>"></script>
    <link rel="stylesheet" href="<?php echo RAIZ . 'vista/css/bootstrap.css'; ?>">
...
<footer class="page-footer font-small unique-color-dark">
  ...
  <div style="background-color: #23A8FF;">
    <div class="container">
